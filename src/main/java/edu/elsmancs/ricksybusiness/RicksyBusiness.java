 ...
 * 
 * Cuando un invitado/a llega a la fiesta, se le da de alta en el receptivo del
 * sistema mediante su tarjeta de crédito.
 * 
 * El receptivo carga en el crédito de la tarjeta: - El coste del UberOvni de
 * vuelta a casa - El coste del pack de bienvenida (Collaxion crystals).
 * 
 * El componente de reserva de Ovnis y el componente de entrega del pack de
 * bienvenida observan al componente receptivo, de modo que cuando el receptivo
 * da de alta a un invitado/a automáticamente cargan en la tarjeta del
 * invitado/a el coste de ambos servicios.
 */
...
public class RicksyBusiness {
	...
	public static void main(String[] args) {
		 ...
		 * invitado/a se le asiga un ovni y un pack y se realiza el cargo a la tarjeta.
		 * 
